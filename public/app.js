...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("C:\\A\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("C:\\A\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _Autocomplete = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListItems = __webpack_require__(165);
	...
	var Autocomplete = function (_Component) {
		...
		_createClass(Autocomplete, [{
			key: 'serchItems',
			value: function serchItems(event) {
			...
			key: 'keySelect',
			value: function keySelect(event) {
			...
			key: 'bottomOffset',
			value: function bottomOffset(event) {

				var listClass = this.listClass;
				var bottomOffset = document.documentElement.clientHeight - (this.inputClass.offsetTop - document.body.scrollTop) - this.inputClass.offsetHeight;
				var topOffset = this.inputClass.offsetTop - document.body.scrollTop;
				var active = this.yesActiveClass;
			...
			key: 'blurInput',
			value: function blurInput(event) {
				var active = this.yesActiveClass; //Выберите значение из списка.

				var listClass = this.listClass; //Список
				...
				if (this.state.error) {
					...
					if ((typeof activeItem === 'undefined' ? 'undefined' : _typeof(activeItem)) === 'object') {
						//Если активный элеменнт есть выводим его
			...
			value: function componentDidMount() {
				...
				var items = document.getElementsByClassName('item');
				this.listClass.onmouseover = function (e) {
					//Выделение элементов при наведении
					if (e.target.classList.contains('item')) {
						_this2.removeActive(); //Удаление всех активных элементов 
						e.target.classList.add('active'); //Выделение элемента
						document.body.style.overflow = 'hidden';
					}
				};
				this.listClass.onmouseout = function (e) {
					if (e.target.classList.contains('item')) {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { type: 'text',
							...
							ref: function ref(input) {
								return _this3.inputClass = input;
							}
						}),
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								'div',
								{ className: 'list', ref: function ref(div) {
										return _this3.listClass = div;
									} },
								_react2.default.createElement(_ListItems2.default, { Data: this.state.data_rez, Length: this.state.data_rez.length, Error: this.state.error })
							),
							_react2.default.createElement(
								'div',
								{ className: 'yesActive', ref: function ref(div) {
										return _this3.yesActiveClass = div;
									} },
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\A\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Autocomplete.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaronScroll = __webpack_require__(166);

	var _BaronScroll2 = _interopRequireDefault(_BaronScroll);
	...
	var ListItems = function (_Component) {
		...
		_createClass(ListItems, [{
			...
			value: function render() {
				...
				if (this.props.Length > 0 && !this.props.Error) {
					...
					var countItrms = Math.round(parseInt(this.serchClass.style.maxHeight) / 30);
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'serch', style: serchStyle, id: 'div', ref: function ref(div) {
									return _this2.serchClass = div;
								} },
							_react2.default.createElement(
								'ul',
								_defineProperty({ className: error }, 'className', 'result'),
								this.props.Data.map(function (item) {
									return _react2.default.createElement(Items, { key: item.Id, City: item.City });
								})
							)
						)
					),
					_react2.default.createElement(
						'div',
						{ className: length1, ref: function ref(div) {
								return _this2.lengthClass = div;
							} },
						length
					)
				);
	...
	var Items = function (_Component2) {
		...
		_createClass(Items, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement('li', { className: 'item', dangerouslySetInnerHTML: { __html: this.props.City } });
			}
		}]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\A\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "ListItems.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baron = __webpack_require__(167);
	...
	var jQueryLike = function jQueryLike(selector, context) {
	    var element;
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function() {
	    ...
	    if (true) {
	        scopedBaron = __webpack_require__(167)
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/autoprefixer-loader/index.js!./StyleFont.css", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/autoprefixer-loader/index.js!./StyleFont.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@font-face {\r\n  font-family: 'SegoeUI';\r\n  src:  url(data:application/x-font-woff;charset=utf-8;base64,) format('woff');\r\n  font-weight: normal;\r\n  font-style: normal;\r\n}\r\n", ""]);
